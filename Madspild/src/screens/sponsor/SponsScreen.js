  ...
  */
      ...
      return (
        <View style={globalStyles.container}>
          <ScrollView>
            <Text style={[styles.headerText, globalStyles.text]}>
              Vores sponsorer, som gør det muligt at drive denne applikation. Se hvilke produkter du kan købe, med dine optjente point!
            </Text>
